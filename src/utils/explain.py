...
def get_sentence_and_id(case:str, sentence_number = 10, sentence_min_len = 10):
    ...
    return case_senteces, case_rationale_id, case_rationale_sentence
...
def get_explanation_features(case_X:str, case_Y:str, sentence_number=10, sentence_min_len=0, relation_ratio=0.2):
    """
    ...
    case_X_senteces, case_X_rationale_id, case_X_rationale_sentence = get_sentence_and_id(case_X, sentence_number, sentence_min_len)
    case_Y_senteces, case_Y_rationale_id, case_Y_rationale_sentence = get_sentence_and_id(case_Y, sentence_number, sentence_min_len)
    ...
    for index_1, index_2 in zip(relation_pair_array[0], relation_pair_array[1]):
        relation_pair.append([case_X_rationale_id[index_1], case_Y_rationale_id[index_2]])
...
if __name__ == '__main__':
    case_X = "2011年6月1日，王建成通过中国农业银行向案外人陈立军打款100000元2011年8月8日，王建成通过中国农业银行向沈高五打款50000元因王建成认为向案外人陈立军打款的100000元中有50000元属于沈高五向其的借款上述两笔合计100000元，沈高五尚未归还，故王建成诉至一审法院，诉请如前庭审中，王建成为证实案外人陈立军打款的100000元中沈高五借款50000元、范某借款50000元，申请范某到庭作证，范某陈述：自己出资50000元，沈高五叫王建成出资50000元，一起打款给陈立军，沈高五与王建成之间50000元是何关系及这笔钱沈高五从陈立军处拿回后有无给王建成，其不知情另查明，2012年4月17日，惠山法院就王建成起诉沈高五民间借贷纠纷一案作出（2012）惠前民初字第0027号民事判决书，其中确认了王建成与沈高五以签订2011年6月11日及2011年8月12日两张还款协议的方式确定双方的借贷关系，结欠借款金额共计920000元，扣除沈高五已经归还的部分，沈高五尚需归还王建成借款220000元及相应违约金该民事判决书现已生效在王建成提供的上述惠山法院案件审理过程中的笔录中，王建成陈述，其与沈高五的借款2011年6月11日前的都已还清，双方从2010年5、6月份就开始有往来，每次借款都有借据，还清的借据都撕掉了，部分有复印件2011年5月至今，共有往来1330000元，沈高五以银行转账的方式还款，或者是现金打的收据，其借出款项给沈高五是有银行本票的案外人朱洪兵与王建成分别于2013年以银行凭单为证，起诉谢峰不当得利和民间借贷应予返还相应款项，无锡市北塘区人民法院（以下简称北塘法院）分别以（2013）北民初字第0261号、0563号民事判决书判决驳回两原告的诉讼请求，认定相应款项已经在上述惠山法院的民事判决中予以处理该两份北塘法院的判决书经上诉、申诉现已生效庭审中，王建成说明，其与沈高五之间的借款往来，都是以签字确认的还款协议为准，而不以银行凭条为依据其不同意惠山法院的民事判决书中仅因银行凭单认定陆林富向其的100000元打款为沈高五的归还欠款，而其凭借银行打款凭证在北塘法院的诉讼却败诉，故其该案中再次以两张银行打款凭证起诉三被告，目的是为了把惠山法院的判决书中多扣的10万元要回来以上事实，由王建成提供的两张银行凭单、惠山法院判决书及笔录、北塘法院判决书、证人范某陈述和当事人陈述等证据在案佐证，一审法院予以确认一审法院认为：公民之间合法的借贷关系受法律保护王建成基于借贷关系主张归还借款的，应当对借贷合意和款项交付等要件事实承担举证责任该案中，关于王建成主张的打款给案外人陈立军的100000元中有50000元为沈高五借款，现王建成仅提供2011年6月1日的银行凭条，而未提供其与沈高五就该笔款项达成借贷合意的证据，其对打款的过程描述与证人范某的陈述亦有矛盾，且王建成提供的惠山法院诉讼过程笔录中其自认在2011年6月11日前与沈高五的经济往来已结清，故对王建成主张给付陈立军100000元款项中50000元系沈高五的借款，应予归还并支付利息的主张，依据不足，一审法院不予支持关于王建成主张的2011年8月8日的50000元的借款，结合王建成在该案庭审中说明的双方的借贷交易习惯为以签字确认的还款协议为准，而不以银行打款凭单为证，且生效的法律文书亦确认双方之间存在多次借贷往来，现王建成仅凭2011年8月8日银行打款凭条主张借款关系存在，依据不足，一审法院不予支持涉案的两笔款项，王建成并未提供任何证据证明与谢峰、陆林富有关，其主张谢峰、陆林富应当对该两笔款项承担连带还款责任，无事实和法律依据，一审法院不予支持王建成要求三被告承担该次诉讼之前其与三被告之间多次诉讼产生的诉讼费用的主张，于法无据，一审法院不予支持综上，依照《中华人民共和国民法通则》第九十条、《中华人民共和国民事诉讼法》第六十四条第一款、《最高人民法院关于民事诉讼证据的若干规定》第二条之规定，作出判决：驳回王建成的诉讼请求案件受理费3976元，由王建成负担王建成与沈高五、谢峰、陆林富对一审法院查明事实无异议，本院予以确认二审中，王建成提供沈高五与赵东签的拆迁合同一份，证明当时谢峰把拆迁工程卖给了沈高五，沈高五又卖给了赵东，王建成考虑到可以获利，才把钱借给沈高五对此，沈高五、谢峰、陆林富质证，该份协议是沈高五签字的劳务合同，协议签订于2010年10月，与本案借款事实时间相差较远，与民间借贷无关本院对该证据的真实性予以确认，该证据只是佐证了借贷目的，未涉及借贷金额等具体内容，本院对其证据关联性不予认可综合双方当事人一、二审诉辩主张，本案的二审争议焦点为：1、王建成向沈高五主张10万元借款是否成立2、如借款成立，谢峰和陆林富是否应当承担共同还款责任本院认为：关于争议焦点一，王建成向沈高五主张归还10万元借款，不应予以支持当事人对自己提出的诉讼请求所依据的事实有责任提供证据加以证明没有证据或者证据不足以证明当事人的事实主张的，由负有举证责任的当事人承担不利后果当事人的主张能否得到法院的支持与认可，应当取决于当事人的证明责任是否完成本案中，王建成为证明沈高五结欠10万元款项，举证了2011年6月1日、2011年8月8日分别向陈立军、沈高五汇款的银行凭条、惠山法院判决书及笔录、北塘法院判决书、证人范某陈述等对此"
    ...
    print(get_explanation_features(case_X, case_Y))